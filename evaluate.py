...
def evaluate_detector(args):
    ...
    F1Score = util.calc_F1Score(precisions, recalls)
...
# python evaluate.py --dataset_directory F:\ubunut_desktop_back\ParkingSlotDetection\allin_eval --detector_weights F:\ubunut_desktop_back\ParkingSlotDetection\DMPR-PS-master\weights\iter2092_loss0.0016.pth