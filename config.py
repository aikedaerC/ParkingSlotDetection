...
def add_common_arguments(parser):
    ...
    parser.add_argument('--num_gpus', type=int, nargs='+', default=[2,3,4,5,6],
                        help="nums of gpu in one machine")


def get_parser_for_training():
    """Return argument parser for training."""
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset_directory', default="F:\\ubunut_desktop_back\\ParkingSlotDetection\\data_extra\\train\\aug\\train", 
...
def get_parser_for_inference():
    ...
    parser.add_argument('--imgsPath', required=True,
                        help="imgsPath")
