...
def vgg16(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(VGG16_Weights.IMAGENET1K_V1))
    return model
...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(ResNet18_Weights.IMAGENET1K_V1), strict=False)
    return model
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(ResNet50_Weights.IMAGENET1K_V2), strict=False)
    return model
